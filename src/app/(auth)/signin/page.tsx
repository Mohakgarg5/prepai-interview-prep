      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-xl">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400 text-sm">Sign in to continue your PM interview prep</p>
          </div>

          <Button
            onClick={handleGoogleSignIn}
            disabled={loading}
            className="w-full bg-white hover:bg-slate-100 text-slate-900 font-medium h-11 rounded-xl flex items-center gap-3"
          >
            {loading ? (
